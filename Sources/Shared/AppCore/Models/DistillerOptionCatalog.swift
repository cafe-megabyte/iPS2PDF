...
enum DistillerOptionCatalog {
    ...
    static let options: [DistillerOptionDefinition] = [
        ...
        option("ColorImageFilter", "Compression and image quality", .images, .name(["DCTEncode", "FlateEncode", "JPXEncode"]), section: .colorImages, keyPaths: ["/EncodeColorImages", "/AutoFilterColorImages", "/ColorImageFilter", "/ColorACSImageDict /QFactor", "/ColorImageDict /QFactor"], semanticEditor: .compression(.color)),
        ...
        option("GrayImageFilter", "Compression and image quality", .images, .name(["DCTEncode", "FlateEncode", "JPXEncode"]), section: .grayscaleImages, keyPaths: ["/EncodeGrayImages", "/AutoFilterGrayImages", "/GrayImageFilter", "/GrayACSImageDict /QFactor", "/GrayImageDict /QFactor"], semanticEditor: .compression(.grayscale)),
        ...
        option("UCRandBGInfo", "Undercolor removal and black generation", .color, .name(["Preserve", "Apply", "Remove"]), section: .deviceDependentColor),
        option("TransferFunctionInfo", "Transfer functions", .color, .name(["Preserve", "Apply", "Remove"]), section: .deviceDependentColor),
        ...
        option("PreserveHalftoneInfo", "Preserve halftone information", .advanced, .boolean, section: .dsc),
